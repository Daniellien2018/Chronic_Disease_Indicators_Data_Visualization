...
Response is all Percentages (prevalence)
2) Current smoking adults with COPD  (Q02)
Response is all Percentages (prevalence)
3) Hospitalization for COPD as any diagnosis, medicare aged 65+ (Q03)
Cases per 1000, number (number, AA rate, crude rate)
4) Hospitalization for COPD as principal diagnosis, medicare aged 65+ (Q04)
Cases per 1000, number (number, AA rate, crude rate)
5) COPD mortality as underlying cause 45+ (Q05)
Cases per 100,000, number (number, AA rate, crude rate)
6) COPD mortality as underlying or contributing cause 45+ (Q06)
Cases per 100,000, number (number, AA rate, crude rate)
...
Combine Hospitalization Rates: Any Diagnosis 
Combine Mortality Rates : underlying and contributing cause
Current COPD 
Current Smoking


My Map will have a year selection (for location/year)
after the year is selected,
I will have 4 Options to select
- hopitalization rate of aged 65 older
- COPD Disease
- Smoking Prevalence
- Mortality Rate 

- Mortality - underlying or contributing

- Hospitalization - first listed diag, any diag, first listed > 65, any diag > 65 

- ED - first listed, any diag

- Prevalence COPd - >= 18, >= 45 

- Prevalence Smoking - >=18, >=45

- Prevalance of cur adult > 18 with copd

- Prevalence of cur adult > 45 with copd

- pneumococcal vaccine among NI adults with >= 45 years
