...
def save_splits(train_df, test_df, train_file='data/split/train.csv', test_file='data/split/test.csv'):
...
if __name__ == "__main__":
    # Load data
    file_path = 'data/processed/merged_copd_income_medicaid.csv'
